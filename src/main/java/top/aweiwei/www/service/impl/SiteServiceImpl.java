...
import top.aweiwei.www.entity.Vo.*;
import top.aweiwei.www.exception.TipException;
import top.aweiwei.www.mapper.AttachVoMapper;
import top.aweiwei.www.mapper.CommentVoMapper;
import top.aweiwei.www.mapper.ContentVoMapper;
import top.aweiwei.www.mapper.MetaVoMapper;
import top.aweiwei.www.service.ISiteService;
import top.aweiwei.www.utils.DateKit;
import top.aweiwei.www.utils.TaleUtils;
import top.aweiwei.www.utils.ZipUtils;
import top.aweiwei.www.utils.backup.Backup;
...
public class SiteServiceImpl implements ISiteService {
    ...
    public StatisticsBo getStatistics() {
        ...
        int articles =   contentDao.countByExample(contentVoExample);

        int  comments = commentDao.countByExample(new CommentVoExample());

        int attachs = attachDao.countByExample(new AttachVoExample());

        MetaVoExample metaVoExample = new MetaVoExample();
        metaVoExample.createCriteria().andTypeEqualTo(Types.LINK.getType());
        int links = metaDao.countByExample(metaVoExample);
